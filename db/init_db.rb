...
DB_CONFIG = {
  ...
  # Add these options for better XAMPP compatibility
  reconnect: true,
  encoding: 'utf8',
...
begin
  ...
  client.query("CREATE DATABASE IF NOT EXISTS #{DB_CONFIG[:database]} CHARACTER SET utf8 COLLATE utf8_unicode_ci")
  ...
  puts "6. Make sure XAMPP MySQL is running on port 3306"
end 